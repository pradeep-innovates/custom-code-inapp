...
public class DetailListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ("HTML In-App".equals(category)) {
            ...
            detailList.add(new DetailCardItem("Lead Generation", "https://example.com/carousel", "lead"));
            ...
            detailList.add(new DetailCardItem("Watch Noe Template", "https://example.com/carousel", "SONY 1"));
